...
class IntegrationConfig:
    ...
    def __init__(self):
        ...
        self.training_evaluations = 1e6  # neval for training
        
        # 计算阶段参数
        self.final_iterations = 20      # nitn for final integration
        self.final_evaluations = 1e6     # neval for final integration
        ...
        self.x0_distribution = {
            ...
            'training_evaluations': 1e6,# 训练采样点数
            'final_iterations': 10,     # 最终迭代次数
            'final_evaluations': 1e6    # 最终采样点数
        }
...
def f(x):
    ...
    result = 128*np.pi**4*((-1+2*x1)*(8-2*x3-2*x4+16*np.log(2)-8*x3*np.log(2)-8*x4*np.log(2)+\
x3*x4*np.log(16)+2*(-2+x3)*(-2+x4)*np.log(1-x1)+2*(-2+x3)*(-2+x4)*np.\
log(x1)+8*np.log(1-x2)-4*x3*np.log(1-x2)-4*x4*np.log(1-x2)+2*x3*x4*np.\
log(1-x2)+8*np.log(x2)-4*x3*np.log(x2)-4*x4*np.log(x2)+2*x3*x4*np.log(\
x2)-16*(np.log(np.abs(1-2*x2))+(1j/2)*np.pi*np.sign(1-2*x2))+8*x3*(np.\
log(np.abs(1-2*x2))+(1j/2)*np.pi*np.sign(1-2*x2))+8*x4*(np.log(np.abs(\
1-2*x2))+(1j/2)*np.pi*np.sign(1-2*x2))-4*x3*x4*(np.log(np.abs(1-2*x2))\
+(1j/2)*np.pi*np.sign(1-2*x2))-4*(np.log(np.abs(2*np.sqrt((1-x1)*x1)*(\
-2*np.sqrt((1-x2)*x2)*np.cos(x0)-(1-2*x2)*np.sin(x0))+(1-2*x1)*((1-2*\
x2)*np.cos(x0)-2*np.sqrt((1-x2)*x2)*np.sin(x0))))+(1j/2)*np.pi*np.\
sign(2*np.sqrt((1-x1)*x1)*(-2*np.sqrt((1-x2)*x2)*np.cos(x0)-(1-2*x2)*\
np.sin(x0))+(1-2*x1)*((1-2*x2)*np.cos(x0)-2*np.sqrt((1-x2)*x2)*np.sin(\
x0))))+2*x3*(np.log(np.abs(2*np.sqrt((1-x1)*x1)*(-2*np.sqrt((1-x2)*x2)\
*np.cos(x0)-(1-2*x2)*np.sin(x0))+(1-2*x1)*((1-2*x2)*np.cos(x0)-2*np.\
sqrt((1-x2)*x2)*np.sin(x0))))+(1j/2)*np.pi*np.sign(2*np.sqrt((1-x1)*\
x1)*(-2*np.sqrt((1-x2)*x2)*np.cos(x0)-(1-2*x2)*np.sin(x0))+(1-2*x1)*((\
1-2*x2)*np.cos(x0)-2*np.sqrt((1-x2)*x2)*np.sin(x0))))+2*x4*(np.log(np.\
abs(2*np.sqrt((1-x1)*x1)*(-2*np.sqrt((1-x2)*x2)*np.cos(x0)-(1-2*x2)*\
np.sin(x0))+(1-2*x1)*((1-2*x2)*np.cos(x0)-2*np.sqrt((1-x2)*x2)*np.sin(\
x0))))+(1j/2)*np.pi*np.sign(2*np.sqrt((1-x1)*x1)*(-2*np.sqrt((1-x2)*\
x2)*np.cos(x0)-(1-2*x2)*np.sin(x0))+(1-2*x1)*((1-2*x2)*np.cos(x0)-2*\
np.sqrt((1-x2)*x2)*np.sin(x0))))-x3*x4*(np.log(np.abs(2*np.sqrt((1-x1)\
*x1)*(-2*np.sqrt((1-x2)*x2)*np.cos(x0)-(1-2*x2)*np.sin(x0))+(1-2*x1)*(\
(1-2*x2)*np.cos(x0)-2*np.sqrt((1-x2)*x2)*np.sin(x0))))+(1j/2)*np.pi*\
np.sign(2*np.sqrt((1-x1)*x1)*(-2*np.sqrt((1-x2)*x2)*np.cos(x0)-(1-2*\
x2)*np.sin(x0))+(1-2*x1)*((1-2*x2)*np.cos(x0)-2*np.sqrt((1-x2)*x2)*np.\
sin(x0))))-4*(np.log(np.abs(2*np.sqrt((1-x1)*x1)*(2*np.sqrt((1-x2)*x2)\
*np.cos(x0)+(1-2*x2)*np.sin(x0))+(1-2*x1)*((1-2*x2)*np.cos(x0)-2*np.\
sqrt((1-x2)*x2)*np.sin(x0))))+(1j/2)*np.pi*np.sign(2*np.sqrt((1-x1)*\
x1)*(2*np.sqrt((1-x2)*x2)*np.cos(x0)+(1-2*x2)*np.sin(x0))+(1-2*x1)*((\
1-2*x2)*np.cos(x0)-2*np.sqrt((1-x2)*x2)*np.sin(x0))))+2*x3*(np.log(np.\
abs(2*np.sqrt((1-x1)*x1)*(2*np.sqrt((1-x2)*x2)*np.cos(x0)+(1-2*x2)*np.\
sin(x0))+(1-2*x1)*((1-2*x2)*np.cos(x0)-2*np.sqrt((1-x2)*x2)*np.sin(x0)\
)))+(1j/2)*np.pi*np.sign(2*np.sqrt((1-x1)*x1)*(2*np.sqrt((1-x2)*x2)*\
np.cos(x0)+(1-2*x2)*np.sin(x0))+(1-2*x1)*((1-2*x2)*np.cos(x0)-2*np.\
sqrt((1-x2)*x2)*np.sin(x0))))+2*x4*(np.log(np.abs(2*np.sqrt((1-x1)*x1)\
*(2*np.sqrt((1-x2)*x2)*np.cos(x0)+(1-2*x2)*np.sin(x0))+(1-2*x1)*((1-2*\
x2)*np.cos(x0)-2*np.sqrt((1-x2)*x2)*np.sin(x0))))+(1j/2)*np.pi*np.\
sign(2*np.sqrt((1-x1)*x1)*(2*np.sqrt((1-x2)*x2)*np.cos(x0)+(1-2*x2)*\
np.sin(x0))+(1-2*x1)*((1-2*x2)*np.cos(x0)-2*np.sqrt((1-x2)*x2)*np.sin(\
x0))))-x3*x4*(np.log(np.abs(2*np.sqrt((1-x1)*x1)*(2*np.sqrt((1-x2)*x2)\
*np.cos(x0)+(1-2*x2)*np.sin(x0))+(1-2*x1)*((1-2*x2)*np.cos(x0)-2*np.\
sqrt((1-x2)*x2)*np.sin(x0))))+(1j/2)*np.pi*np.sign(2*np.sqrt((1-x1)*\
x1)*(2*np.sqrt((1-x2)*x2)*np.cos(x0)+(1-2*x2)*np.sin(x0))+(1-2*x1)*((\
1-2*x2)*np.cos(x0)-2*np.sqrt((1-x2)*x2)*np.sin(x0))))-4*(np.log(np.\
abs(2*np.sqrt((1-x1)*x1)*(2*np.sqrt((1-x2)*x2)*np.cos(x0)-(1-2*x2)*np.\
sin(x0))+(1-2*x1)*((1-2*x2)*np.cos(x0)+2*np.sqrt((1-x2)*x2)*np.sin(x0)\
)))+(1j/2)*np.pi*np.sign(2*np.sqrt((1-x1)*x1)*(2*np.sqrt((1-x2)*x2)*\
np.cos(x0)-(1-2*x2)*np.sin(x0))+(1-2*x1)*((1-2*x2)*np.cos(x0)+2*np.\
sqrt((1-x2)*x2)*np.sin(x0))))+2*x3*(np.log(np.abs(2*np.sqrt((1-x1)*x1)\
*(2*np.sqrt((1-x2)*x2)*np.cos(x0)-(1-2*x2)*np.sin(x0))+(1-2*x1)*((1-2*\
x2)*np.cos(x0)+2*np.sqrt((1-x2)*x2)*np.sin(x0))))+(1j/2)*np.pi*np.\
sign(2*np.sqrt((1-x1)*x1)*(2*np.sqrt((1-x2)*x2)*np.cos(x0)-(1-2*x2)*\
np.sin(x0))+(1-2*x1)*((1-2*x2)*np.cos(x0)+2*np.sqrt((1-x2)*x2)*np.sin(\
x0))))+2*x4*(np.log(np.abs(2*np.sqrt((1-x1)*x1)*(2*np.sqrt((1-x2)*x2)*\
np.cos(x0)-(1-2*x2)*np.sin(x0))+(1-2*x1)*((1-2*x2)*np.cos(x0)+2*np.\
sqrt((1-x2)*x2)*np.sin(x0))))+(1j/2)*np.pi*np.sign(2*np.sqrt((1-x1)*\
x1)*(2*np.sqrt((1-x2)*x2)*np.cos(x0)-(1-2*x2)*np.sin(x0))+(1-2*x1)*((\
1-2*x2)*np.cos(x0)+2*np.sqrt((1-x2)*x2)*np.sin(x0))))-x3*x4*(np.log(\
np.abs(2*np.sqrt((1-x1)*x1)*(2*np.sqrt((1-x2)*x2)*np.cos(x0)-(1-2*x2)*\
np.sin(x0))+(1-2*x1)*((1-2*x2)*np.cos(x0)+2*np.sqrt((1-x2)*x2)*np.sin(\
x0))))+(1j/2)*np.pi*np.sign(2*np.sqrt((1-x1)*x1)*(2*np.sqrt((1-x2)*x2)\
*np.cos(x0)-(1-2*x2)*np.sin(x0))+(1-2*x1)*((1-2*x2)*np.cos(x0)+2*np.\
sqrt((1-x2)*x2)*np.sin(x0))))-4*(np.log(np.abs(2*np.sqrt((1-x1)*x1)*(-\
2*np.sqrt((1-x2)*x2)*np.cos(x0)+(1-2*x2)*np.sin(x0))+(1-2*x1)*((1-2*\
x2)*np.cos(x0)+2*np.sqrt((1-x2)*x2)*np.sin(x0))))+(1j/2)*np.pi*np.\
sign(2*np.sqrt((1-x1)*x1)*(-2*np.sqrt((1-x2)*x2)*np.cos(x0)+(1-2*x2)*\
np.sin(x0))+(1-2*x1)*((1-2*x2)*np.cos(x0)+2*np.sqrt((1-x2)*x2)*np.sin(\
...
np.sign(2*np.sqrt((1-x1)*x1)*(-2*np.sqrt((1-x2)*x2)*np.cos(x0)+(1-2*\
x2)*np.sin(x0))+(1-2*x1)*((1-2*x2)*np.cos(x0)+2*np.sqrt((1-x2)*x2)*np.\
sin(x0))))))/(64*np.pi**6*np.sqrt(1-x1)*np.sqrt(x1)*np.sqrt(1-x2)*np.\
sqrt(x2)*(-2+x3)*(-2+x4)*np.sqrt(2-x5)*np.sqrt(x5)*np.sqrt(x6)*(2-x5+\
2*(-1+2*x1)*np.sqrt(2-x5)*np.sqrt(x5)*np.sqrt(x6)+x5*x6))
